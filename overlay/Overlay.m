...
- (bool)isEqualTo:(Overlay *)overlay {
	return
		...
		&& ( _reloadOnEnable == overlay->_reloadOnEnable )
...
- (NSDictionary*)toDictionary {
	...
	[d setObject:[NSNumber numberWithBool:self.reloadOnEnable] forKey:@"reloadOnEnable"];
...
- (void)fromDictionary:(NSDictionary *)d {
	...
	self.reloadOnEnable = [[d objectForKey:@"reloadOnEnable"] boolValue];
...
//!	self.webView = overlay.webView;
	...
	self.reloadOnEnable = overlay.reloadOnEnable;
...
- (id)copyWithZone:(NSZone *)zone {
	...
	overlay->_reloadOnEnable = _reloadOnEnable;
